      ...
      child: ResponsiveWidget(
        ...
        medium: (_) => Row(
          children: [
            ...
            const SizedBox(width: 16),
            Expanded(child: _QuickUploadTile(icon: Icons.folder_open_rounded, label: 'Browse', gradient: const LinearGradient(colors: [Color(0xFF8B5CF6), Color(0xFF6D28D9)]), onTap: () => UploadSheet.show(context))),
          ],
        ),
        large: (_) => Row(
          children: [
